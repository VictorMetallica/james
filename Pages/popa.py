...
class popa:
    ...
    def app(self):
        st.title('Smotrite yopta')

        source_option = st.selectbox(
            "Choose istochnik chopuh",
            ("Mobila","Youtube Link","Local Drive","Web-Camera","RTSP")
        )
        ...
        if source_option == "Mobila":
            img_file = st.camera_input("Photka")
        ...
        run_button = st.button("Launching")
